...
2. تحليل تاريخ الصلاحية وحساب الأيام المتبقية (التاريخ الحالي: 2025-12-28)
3. تصنيف المكونات إلى: إيجابية، سلبية، مشكوك فيها
4. تقييم الممارسات التسويقية والادعاءات
5. تقديم تقرير طبي مفصل
...

{
  ...
  "safety_disclaimer": "هذا التحليل هو مرجع معلوماتي يعتمد على الذكاء الاصطناعي ولا يغني عن استشارة الطبيب أو الصيدلاني. يرجى مراجعة مختص قبل اتخاذ أي قرار طبي."
}
